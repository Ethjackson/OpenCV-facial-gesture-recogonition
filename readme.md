# A small personal project utilizing openCV and MediaPipe for the first time.
...
More would could definitly be added one day to make it an actual profanity filter, with models to detect profanity from image datasets
